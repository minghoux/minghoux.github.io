...
const template = `
  <div class="w-full animate-fade-slide-in flex flex-col gap-10">
    ...
    <!-- Success Hero -->
    <div class="bg-brand border-1.5 border-brand/10 rounded-large p-10 flex flex-col items-center gap-6 text-white text-center">
      <div class="w-20 h-20 rounded-full bg-white flex items-center justify-center text-brand text-[40px] animate-scale-in">
    ...
    <div class="flex flex-col gap-10">
      ...
      <div class="flex flex-col gap-6">
        ...
        <div class="flex flex-col gap-5 bg-white border-1.5 border-charcoal/5 rounded-large p-8">
